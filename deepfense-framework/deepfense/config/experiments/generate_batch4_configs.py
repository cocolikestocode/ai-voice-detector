...
# --- Constants ---
OUTPUT_DIR = "/netscratch/yelkheir/DeepFense/DeepFense/deepfense/config/experiments/batch4_CtrSVDD"
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Base Paths
TRAIN_PARQUET = "/netscratch/yelkheir/DeepFense/DeepFense/deepfense/config/parquets/CtrSVDD/ctrsvdd_train.parquet"
VAL_PARQUET = "/netscratch/yelkheir/DeepFense/DeepFense/deepfense/config/parquets/CtrSVDD/ctrsvdd_val.parquet"
...
BASE_CONFIG = {
    "exp_name": "",
    "output_dir": "./outputs/batch5_CtrSVDD/",
    "seed": 42,
    "data": {
        "sampling_rate": 16000,
    ...
    for backend in BACKENDS:
        for seed in SEEDS:
            for aug in AUGMENTATIONS:
                ...
                b_name = backend["type"]
                aug_name = aug["name"]
                exp_name = f"CtrSVDD_{f_name}_{b_name}_{aug_name}_seed{seed}"
