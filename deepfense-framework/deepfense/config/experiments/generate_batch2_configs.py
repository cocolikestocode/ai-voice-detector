...
# --- Constants ---
OUTPUT_DIR = "deepfense/config/experiments/batch2"
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Base Paths
TRAIN_PARQUET = "/netscratch/yelkheir/DeepFense/DeepFense/deepfense/config/parquets/asvspoof19_train.parquet"
VAL_PARQUET = "/netscratch/yelkheir/DeepFense/DeepFense/deepfense/config/parquets/asvspoof19_val.parquet"
    ...
    {"name": "Concat_RawBoost_RIR", "augment_transform": [
        {
            ...
            "transforms": [
                ...
                {"type": "rir", "noise_ratio": 1.0, "csv_file": "/netscratch/yelkheir/DeepFense/DeepFense/deepfense/config/augmentations/rir.csv"} 
            ]
        }
    ]}
]
